...
@section('content')
 ...
 <div class="row">
                            ...
                            <div class="card-body p-b-0">
                                ...
                                <div class="tab-content">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                          ...
                                                          data-dokid="{{$dokumen->id}}"
                                                           data-target="#editDokumenstd" data-original-title="Edit"><i class="fa fa-edit"></i></button>
                                    ...
                                    <div class="tab-pane" id="tab2" role="tabpanel">
                                        <div class="table-responsive m-t-10">
                                            <a href="#" data-toggle="modal" data-target="#addDokumenpem"> <button class="btn btn-block btn-md btn-success" type="submit">
                                            <i class="fa fa-user-plus"></i>
                                            ...
                                            <table id="myTable4" class="table table-bordered table-striped m-t-10">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                        <button class="btn btn-warning btn-sm" data-toggle="modal"
                                                          data-myuserpem="{{$row->user_id}}"
                                                          data-mynamapem="{{$row->kode_dokumen}}"
                                                          data-mycatpem="{{$row->catatan}}"
                                                          data-myfilepem="{{$row->file}}"
                                                          data-dokpemid="{{$row->id}}"
                                                           data-target="#editDokpem" data-original-title="Edit"><i class="fa fa-edit"></i></button>
                                                          <button class="btn btn-danger btn-sm" data-toggle="tooltip" data-original-title="Hapus"><i class="fa fa-trash"></i></button>
                                                        </td>
                                                    </tr>
                                                    @endforeach
      ...
      <div class="modal fade" id="addDokumenpem" tabindex="0" role="dialog" aria-labelledby="exampleModalLabel1">
          <div class="modal-dialog modal-md" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                    {!! Form::open(array('route'=> 'dokpem.store','class'=>'form-horizontal m-t-10','novalidate'=>'novalidate')) !!}
                    @csrf
                    <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
    ...
    <!-- END MODAL ADD Dokumen Pemberian -->
     ...
     <!-- MODAL EDIT Dokumen Pemberrian -->
      <div class="modal fade" id="editDokpem" tabindex="0" role="dialog" aria-labelledby="exampleModalLabel1">
          <div class="modal-dialog modal-md" role="document">
              <div class="modal-content">
                  <div class="modal-header">
                ...
                <div class="modal-body">
                    {!! Form::model(array('route'=> ['dokpem.store',$row->id], 'method'=>'PATCH', 'class'=>'form-horizontal m-t-10','novalidate'=>'novalidate')) !!}
                    @csrf
                    <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <div class="controls">
                                <?php $user_list = App\User::where('name', '!=', null)->pluck('name', 'id')->all();?>
                                    <label for="recipient-name" class="control-label">User:</label>
                                    <div class="controls">{!! Form::select('user_id', [''=>'Pilih User'] + $user_list, null, ['class' => 'form-control','id'=>'iduser', 'required data-validation-required-message'=>'Tidak Boleh Kosong']) !!}</div>
                            </div>
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <?php $list_dok = App\Dokumen::where('tipe', 'Pemberian Bapem', null)->pluck('nama_dokumen', 'kode_dokumen')->all();?>
                                    <label for="recipient-name" class="control-label">Nama Dokumen:</label>
                                    <div class="controls">{!! Form::select('kode_dokumen', [''=>'Pilih dokumen'] + $list_dok, null, ['class' => 'form-control','id'=>'namadokpem', 'required data-validation-required-message'=>'Tidak Boleh Kosong']) !!}</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="recipient-name" class="control-label">Catatan:</label>
                            <div class="controls">{!! Form::text('catatan',null,['class'=>'form-control','id'=>'cttn','required data-validation-required-message'=>'Tidak Boleh Kosong'])!!}</div>
                        </div>
                    </div>
                    </div>
                    <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="recipient-name" class="control-label">File:</label>
                            <div class="controls">{!! Form::file('file',null,['class'=>'form-control','id'=>'files'])!!}</div>
                        </div>
                    </div>
                    <input type="hidden" name="dokpem_id" id="pemid">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
    ...
    <!-- END MODAL EDIT Dokumen Pemberian -->
...
<!-- end - This is for export functionality only -->
    ...
    $('#editDokpem').on('show.bs.modal', function (event) {
      ...
      var button = $(event.relatedTarget) // Button that triggered the modal
      var userpem = button.data('myuserpem') 
      var namadokpem = button.data('mynamapem') 
      var catatandokpem = button.data('mycatpem') 
      var filepem = button.data('myfilepem') 
      var dokpem_id = button.data('dokpemid') 
     
      var modal = $(this)
      modal.find('.modal-body #iduser').val(userpem);
      modal.find('.modal-body #namadokpem').val(namadokpem);
      modal.find('.modal-body #cttn').val(catatandokpem);
      modal.find('.modal-body #files').val(filepem);
      modal.find('.modal-body #pemid').val(dokpem_id);
    })
